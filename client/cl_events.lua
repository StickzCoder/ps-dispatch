...
local function VehicleTheft(vehicle)
    ...
    TriggerServerEvent("dispatch:server:notify", {
        ...
        job = { "police", "sheriff", "lspd", "lscs", "sahp", "bcso", "ambulance" }
    })
end
...
local function StoreRobbery(camId)
    ...
    TriggerServerEvent("dispatch:server:notify", {
        ...
        job = { "police", "sheriff", "lspd", "lscs", "sahp", "bcso", "ambulance" } -- jobs that will get the alerts
    })
end
...
local function OfficerDown()
    ...
    TriggerServerEvent("dispatch:server:notify", {
        ...
        job = { "ambulance", "police", "sheriff", "lspd", "lscs", "sahp", "bcso", "ambulance" } -- jobs that will get the alerts
    })
end
...
local function CustomAlert(data)
    ...
    local job = { "police", "sheriff", "lspd", "lscs", "sahp", "bcso", "ambulance" }
